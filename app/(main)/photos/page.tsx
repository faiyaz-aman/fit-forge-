          ...
          <CardContent className="flex flex-col items-center justify-center text-center space-y-6 pt-6">
            ...
            <div className="space-y-2">
              <h2 className="text-xl md:text-2xl font-extrabold uppercase tracking-tight text-foreground">
                Progress <span className="text-primary">Vault</span>
              </h2>
              <p className="text-xs text-muted-foreground max-w-sm mx-auto leading-relaxed">
                We are building an end-to-end client-encrypted photo vault. Your progress photos are encrypted directly inside your browser using AES-GCM-256 before being uploaded, ensuring complete privacy.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full pt-4 border-t border-border/40 text-left">
              <div className="space-y-1.5 p-3.5 rounded-xl bg-secondary/20 border border-border">
                ...
                <p className="text-[10px] text-muted-foreground leading-normal">
                  Derives zero-knowledge keys in browser to encrypt raw bytes before storage upload.
                </p>
              </div>
              ...
              <div className="space-y-1.5 p-3.5 rounded-xl bg-secondary/20 border border-border">
                ...
                <p className="text-[10px] text-muted-foreground leading-normal">
                  Track fat percentage drops and posture changes with a swipe-comparator timeline.
                </p>
              </div>
            </div>
          </CardContent>
